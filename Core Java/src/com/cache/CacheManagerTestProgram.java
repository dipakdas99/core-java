...
public class CacheManagerTestProgram {
	...
	public static void main(String[] args) {
		 ...
		 */
		String s = new String("ABCDEFGHIJKLMNOPQRSTUVWXYZD");
		/* Create an instance of CachedObject, set the minutesToLive to 1 minute.  Give the object some unique identifier.
		 */
